...
public class CadastroGrupoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        grupo = new Grupo(); //Assim que eu crio o grupo, eu ja registro no firebase o identificador pelo getKey() que deixei no Construtor;
        ...
        //Configurar recyclerView (que ficará na horizontal)
        ...
        fabSalvarGrupo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Adiciona o usuário que estpa logado à lista de membros que farão parte do grupo
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if( resultCode == RESULT_OK ){
            ...
            try{
                ...
                if ( imagem != null ){
                    //Se caiu aqui é pq existe uma imagem armazenada que foi pega usando o metodo ACTION.PICK
                    imageGrupo.setImageBitmap( imagem );

                    //Recuperar dados da imagem em byte
